...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_BYTE =
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                broadcastUpdate(intentAction, mBluetoothGatt.getDevice().getName());
                Log.i(TAG, "Connected to GATT server.+devName="+mBluetoothGatt.getDevice().getName());
    ...
    private void broadcastUpdate(final String action,String extraData,byte[] extraByte) {
        final Intent intent = new Intent(action);
        ...
        // http://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer.aspx?u=org.bluetooth.characteristic.heart_rate_measurement.xml{
         ...
         if (data != null && data.length > 0) {
                ...
                for(byte byteChar : data)
                    stringBuilder.append(String.format("%02X ", byteChar));
             intent.putExtra(EXTRA_DATA, new String(data) + "\n" + stringBuilder.toString());
             intent.putExtra(EXTRA_BYTE, data);
         }
